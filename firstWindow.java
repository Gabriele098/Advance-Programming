		...
		joinButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					// if that checks if the server details are correct
					...
					}else if(msgFromServer.equals("coordinator")) { 										//se e' il primo va ad essere il coordinatore
						frame.dispose();
						JOptionPane.showMessageDialog(frame,  "Sei il primo e coordinatore del gruppo! \n");
						new secondWindow(id, socket, ip, port);
					}else {
