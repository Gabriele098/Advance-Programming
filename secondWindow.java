...
//	}
	...
	public secondWindow(String id, Socket s) { // constructor call, it will initialize required variables
		...
		try {
			...
			OnlineClientsList.setModel(dm);// show that list on UI component JList named OnlineClientsList
